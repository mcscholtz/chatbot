...
def decode(query_q, resp_q, ctl_q):
  with tf.Session() as sess:
    ...
    # Load vocabularies.
    enc_vocab_path = os.path.join(config['working_directory'],"vocab%d.enc" % config['enc_vocab_size'])
    dec_vocab_path = os.path.join(config['working_directory'],"vocab%d.dec" % config['dec_vocab_size'])
